...
The C ABI also exposes the hybrid E2E functions (`ope_e2e_*`, see [`../README.md`](../README.md)). A consumer-side koffi wrapper for the full hybrid request/response flow lives in the TeeChat inference engine (`vendor/inference-engine/src/native/ope-ffi.ts`); the envelope helpers here cover sign/verify.
